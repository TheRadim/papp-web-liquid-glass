...
export function SolutionOutcomes({ locale }: { locale: Locale }) {
  ...
  return <div className="solution-outcomes">
    <div className="solution-outcomes__lead"><p className="eyebrow">{da ? "Fra spørgsmål til handling" : "From question to action"}</p><h2>{da ? "Én klarere vej frem." : "One clearer way forward."}</h2><p className="solution-outcomes__deployment">{da ? "Midlertidigt eller permanent. Mobilt eller fast. Batteri eller netstrøm. Tilpasset jeres sted." : "Temporary or permanent. Mobile or fixed. Battery or mains. Adapted to your site."}</p></div>
